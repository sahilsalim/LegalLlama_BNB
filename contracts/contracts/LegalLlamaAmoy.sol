...
contract LegalLlama is ERC721URIStorage, FunctionsClient, ConfirmedOwner {
    ...
    constructor() FunctionsClient(router) ConfirmedOwner(msg.sender) ERC721("LL NFT", "LLNFT") {
    ...
    function apiCallMinAsset(
        ...
        isFulfilled = false;
        lastRqstTokenId = mintPDF(msg.sender);
