...
contract Receive is CCIPReceiver  {
    ...
    function mintNFT(address _to, string memory _tokenURI) public {
        uint _tokenId = legalLlama.mintPDF(_to);
        legalLlama.setURI(_tokenId, _tokenURI);
    }
}